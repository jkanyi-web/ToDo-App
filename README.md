...
# 📖 [Awesome-Bks-Es6] <a name="about-project"></a>

**[Awesome-Bks-Es6]** is a restructured Awesome books app. It's JS file has been organized by using modules. 
...
- **[A section to display all the existing books]**
- **[A section to add a new book into the list]**
- **[A section to remove a book from the list]**
...
- [Live Demo Link](https://jkanyi-web.github.io/Awesome-Bks-Es6/)
